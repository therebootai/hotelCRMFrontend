      ...
      <div className="bg-white rounded-2xl max-w-4xl w-full border border-gray-100 shadow-2xl flex flex-col max-h-[90vh] overflow-hidden animate-in zoom-in duration-250">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          {selectedBill.roomChargesBreakdown && selectedBill.roomChargesBreakdown.length > 0 && (
            <div>
              <h4 className="text-xs font-black text-gray-700 uppercase tracking-wider mb-2">Room Charges Breakdown</h4>
          ...
          {selectedBill.extraServices && selectedBill.extraServices.length > 0 && (
            <div>
              <h4 className="text-xs font-black text-gray-700 uppercase tracking-wider mb-2">Extra Services Added</h4>
              <div className="border border-gray-100 rounded-xl overflow-hidden">
                <table className="w-full text-xs text-left">
                  <thead className="bg-gray-50 text-[9px] uppercase font-black text-gray-400 tracking-wider">
                    <tr>
          ...
          <div>
            <h4 className="text-xs font-black text-gray-700 uppercase tracking-wider mb-2">Payment History</h4>
            {selectedBill.payments && selectedBill.payments.length > 0 ? (
              ...
              <p className="text-xs text-gray-400 font-bold p-3 border border-gray-50 border-dashed rounded-xl">No payments logged yet.</p>
            )}
          </div>
          ...
          <div className="border-t border-gray-100 pt-4 flex flex-col md:flex-row justify-between gap-4">
            <div className="max-w-md w-full text-xs text-gray-500 font-bold">
              {selectedBill.notes && (
            ...
            <div className="w-80 space-y-1.5 text-xs">
              ...
              <div className="flex justify-between font-black text-gray-800 text-sm border-t border-gray-100 pt-1.5">
              ...
              <div className="flex justify-between font-black text-red-600 border-t border-dashed border-gray-200 pt-1.5 text-sm bg-red-50/50 p-2 rounded-lg">
