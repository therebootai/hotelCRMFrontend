...
const ProcessBillingModal: React.FC<ProcessBillingModalProps> = ({
 ...
 <p className="mt-2 text-sm text-gray-400 font-bold">Recalculating stays & pulling active ledger reports...</p>
 </div>
 )}
 ...
 <span className="font-black text-base">₹{remainingDue.toLocaleString()}</span>
 </div>
 </div>
 </div>
