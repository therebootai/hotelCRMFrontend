...
const CancelBookingModal = ({
 ...
 <div>
 <label className="text-sm font-bold text-gray-600 uppercase tracking-wide block mb-1.5">
 Cancellation Reason *
 </label>
 <textarea
 value={reason}
 onChange={(e) => setReason(e.target.value)}
 className="w-full border border-gray-200 rounded-xl p-3 text-base bg-white outline-none focus:border-red-300 focus:ring-1 focus:ring-red-200 resize-none"
 rows={3}
 ...
 max={paidAmount}
 className="w-full border border-gray-200 rounded-xl p-3 text-base font-bold bg-white outline-none focus:border-red-300 focus:ring-1 focus:ring-red-200"
 ...
 <button
 onClick={onClose}
 className="px-6 py-2 text-base font-bold text-gray-500 hover:text-gray-700 transition-colors"
 >
 Keep Booking
 </button>
 <button
 ...
 className="px-6 py-2 bg-red-500 hover:bg-red-600 text-white rounded-xl font-bold text-base flex items-center gap-2 disabled:opacity-50 transition-all"
 >
 {loading ? (
