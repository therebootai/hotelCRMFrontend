...
const Counter = ({ value, onChange, min = 0, max = 10 }: any) => (
  <div className="flex items-center border border-border rounded-lg overflow-hidden bg-white h-9">
    ...
    <span className="w-10 text-center font-bold text-xs text-text-primary">
      {value}
    </span>
    <button
      type="button"
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 new-booking-modal-container">
      <style>{`
        ...
        @media (min-width: 1440px) {
          ...
          .new-booking-modal-container .text-xs { font-size: 0.85rem !important; }
          .new-booking-modal-container .text-[10px] { font-size: 0.75rem !important; }
          .new-booking-modal-container .text-sm { font-size: 1rem !important; }
        ...
        @media (min-width: 3440px) {
          ...
          .new-booking-modal-container .text-xs { font-size: 1.75rem !important; }
          .new-booking-modal-container .text-sm { font-size: 2rem !important; }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-2">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full border border-border rounded-lg p-2 text-xs bg-white outline-none focus:border-primary focus:ring-1 focus:ring-primary"
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-3 p-4 bg-white border border-border rounded-xl mt-3 animate-fade-in">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-border rounded-lg p-2 text-xs font-bold text-primary bg-white outline-none"
                      placeholder="0"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-7 gap-3">
                  <div className="col-span-2">
                    ...
                    <div className="relative">
                      <DatePicker
                        ...
                        className="w-full border border-border rounded-lg p-2 text-xs bg-white outline-none focus:border-primary"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      disabled
                      value={totalNights}
                      className="w-full border border-border rounded-lg p-2 text-xs bg-slate-50 text-text-secondary text-center font-bold"
                    />
                  </div>
                  ...
                  <div className="col-span-2">
                    ...
                    <select
                      ...
                      className="w-full border border-border rounded-lg p-2 text-xs bg-white outline-none text-text-primary font-bold"
                    >
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full border border-border rounded-lg pl-9 pr-3 py-2 text-xs bg-white outline-none focus:border-primary focus:ring-1 focus:ring-primary font-bold"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full border border-border rounded-lg pl-9 pr-3 py-2 text-xs bg-white outline-none focus:border-primary focus:ring-1 focus:ring-primary font-medium"
            ...
            <div className="bg-white border border-border rounded-xl p-5">
              <div className="flex justify-between items-center mb-4">
                ...
                <button
                  ...
                  className="flex items-center gap-1 text-xs font-black text-primary hover:underline uppercase tracking-wide"
                >
              ...
              {extraServices.length > 0 ? (
                ...
                <p className="text-xs text-text-secondary text-center py-4 bg-slate-50 rounded-xl">
          ...
          <div className="lg:col-span-1 bg-slate-50/50 p-6 border-t lg:border-t-0 lg:border-l border-border flex flex-col justify-between overflow-y-visible lg:overflow-y-auto custom-sidebar-scroll">
                  ...
                  {taxOptions.length > 0 && (
                    <div className="pt-2">
                      ...
                      <select
                        ...
                        className="w-full border border-border rounded-lg p-2 text-xs bg-white outline-none font-bold text-text-primary focus:border-primary focus:ring-1 focus:ring-primary"
                      >
                        {taxOptions.map((tax) => (
                  ...
                  {bookingStatus === "Hold" && (
                    <div className="animate-fade-in">
                      ...
                      <DatePicker
                        ...
                        className="w-full border border-border rounded-lg p-2 text-xs bg-white outline-none focus:border-primary font-bold"
                      />
                    </div>
                  )}
            ...
            <div className="mt-6 pt-4 border-t border-border flex flex-col gap-2">
              <button
                ...
                disabled={loading}
                className="w-full py-3 bg-primary hover:bg-primary-hover text-white rounded-xl font-bold text-xs transition-all flex items-center justify-center gap-2 shadow-lg shadow-orange-100 disabled:opacity-50"
              >
                {loading ? (
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  disabled={loading}
                  className="py-2.5 bg-slate-100 hover:bg-slate-200 text-text-primary rounded-xl font-bold text-xs transition-all"
                >
                ...
                <button
                  type="button"
                  onClick={onClose}
                  className="py-2.5 border border-border hover:bg-slate-50 text-text-secondary rounded-xl font-bold text-xs transition-all text-center"
                >
                  Back to List
                </button>
              </div>
