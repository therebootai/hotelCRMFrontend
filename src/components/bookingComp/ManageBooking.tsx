...
const ManageBooking = ({
 ...
 <div key={idx} className="bg-white border border-gray-100 shadow-sm rounded-xl p-3 flex items-center justify-between gap-3 hover:shadow-md transition-all ">
 <span className="text-[10px] font-bold text-gray-500 uppercase tracking-wider leading-tight ">{kpi.label}</span>
 ...
 className={`flex items-center justify-center gap-1.5 px-4 py-1.5 rounded-lg text-sm font-bold transition-all ${viewType === "Individual" ? "bg-white text-orange-600 shadow-sm" : "text-gray-400"}`}
 >
 ...
 className={`flex items-center justify-center gap-1.5 px-4 py-1.5 rounded-lg text-sm font-bold transition-all ${viewType === "Corporate" ? "bg-white text-blue-600 shadow-sm" : "text-gray-400"}`}
 >
 ...
 className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-transparent focus:border-orange-200 focus:bg-white rounded-xl outline-none transition-all text-sm font-medium text-gray-700 "
 ...
 className="shrink-0 h-[2.5rem] px-5 flex justify-center items-center bg-gradient-to-r from-orange-500 to-orange-400 hover:from-orange-600 hover:to-orange-500 transition-all rounded-xl text-white font-bold gap-2 shadow-lg shadow-orange-100 active:scale-95 "
 >
 <FiPlus className=" " /> <span className="hidden md:inline">New Booking</span>
 </button>
 </div>
 </div>
 ...
 {/* Table Header */}
 <div className="flex items-center bg-gray-50/70 border-b border-gray-100 px-4 py-3 text-[9px] font-black text-gray-400 uppercase tracking-widest min-w-[1050px] lg:min-w-0 ">
 ...
 <p className="mt-2 text-sm text-gray-400 font-bold ">Loading bookings...</p>
 </div>
 ) : data.length === 0 ? (
 ...
 <span className="text-base font-bold text-gray-800 ">{guestName}</span>
 ...
 <p className="text-base font-bold text-gray-700 ">{item.totalNights || 1}</p>
 </div>
 ...
 <span className={`inline-block px-3 py-1 rounded-full text-[10px] font-black uppercase ${statusBadge.bg} ${statusBadge.text}`}>
 {item.status}
 </span>
 </div>
