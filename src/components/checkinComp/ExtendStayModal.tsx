...
const ExtendStayModal = ({ checkIn, onClose, onSuccess, prefillCheckout }: ExtendStayModalProps) => {
 ...
 <span className="text-sm font-bold text-gray-400">(₹{currentRoom.appliedPrice}/night)</span>
 </p>
 </div>
 ...
 <h3 className="text-sm font-black text-green-700 uppercase">Payment Tracking</h3>
 ...
 className="p-4 bg-white border border-green-100 rounded-2xl font-bold text-sm text-green-700 outline-none"
 >
 ...
 className="w-full pl-12 pr-4 py-4 bg-white border border-green-100 rounded-2xl text-sm font-medium outline-none"
