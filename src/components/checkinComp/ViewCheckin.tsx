          ...
          <div className="bg-green-50 rounded-lg p-3 border border-green-100">
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="bg-white rounded p-2 text-center border border-green-100">
                ...
                <span className="text-sm font-black text-gray-800">₹{checkIn.paymentSummary?.totalAmount?.toLocaleString() || 0}</span>
              </div>
              <div className="bg-white rounded p-2 text-center border border-green-100">
                <span className="text-[9px] text-gray-400 block">Paid</span>
                <span className="text-sm font-black text-green-600">₹{checkIn.paymentSummary?.totalPaid?.toLocaleString() || 0}</span>
              </div>
              <div className="bg-white rounded p-2 text-center border border-green-100">
                <span className="text-[9px] text-gray-400 block">Due</span>
                <span className="text-sm font-black text-red-500">₹{checkIn.paymentSummary?.dueAmount?.toLocaleString() || 0}</span>
              </div>
            </div>
