...
const Pagination = ({ currentPage, totalPages, onPageChange }: PaginationProps) => {
 return (
 <div className="flex flex-col sm:flex-row gap-4 items-center justify-between px-6 py-4 bg-white border-t border-gray-100 ">
 ...
 >
 <FiChevronLeft size={18} className=" " />
 </button>
 ...
 className="p-2 rounded-lg border border-gray-200 hover:bg-gray-50 disabled:opacity-30 disabled:cursor-not-allowed transition-all "
 >
 <FiChevronRight size={18} className=" " />
 </button>
 </div>
 </div>
 );
