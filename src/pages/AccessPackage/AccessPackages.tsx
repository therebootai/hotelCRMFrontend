...
export default function AccessPackages() {
  ...
  return (
    <div className="flex flex-col w-full h-full p-8 max-w-7xl mx-auto relative page-container animate-fade-in">
      {/* Header */}
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50/50 border-b border-border">
                <th className="text-[10px] font-bold text-text-secondary uppercase tracking-wider py-4 px-6 w-[35%]">
                  Package Details
                </th>
                <th className="text-[10px] font-bold text-text-secondary uppercase tracking-wider py-4 px-6">
                  Price
                </th>
                <th className="text-[10px] font-bold text-text-secondary uppercase tracking-wider py-4 px-6">
                  Timings
                ...
                <th className="text-[10px] font-bold text-text-secondary uppercase tracking-wider py-4 px-6 text-right w-32">
                  Actions
                </th>
              </tr>
            </thead>
