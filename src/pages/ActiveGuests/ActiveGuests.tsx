...
const ActiveGuests = () => {
 ...
 className="w-full bg-white border border-border rounded-xl pl-11 pr-4 py-2.5 text-base text-text-primary placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-primary transition-shadow"
 />
 </div>
 </div>
 ...
 <span className="text-sm text-text-secondary font-medium uppercase tracking-wide flex items-center gap-1">
 <FiClock size={12} />
 Checked In
 </span>
 </div>
 ...
 <Link
 to="/billing"
 className="flex-1 flex items-center justify-center gap-1.5 px-4 py-2.5 bg-primary text-white text-sm font-bold rounded-xl hover:bg-primary-dark transition-colors cursor-pointer"
 >
 <FiLogOut size={14} />
 Checkout Folio
 </Link>
