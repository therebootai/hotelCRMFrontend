        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-1">
              <label className="text-[10px] 3xl:text-[12px] font-bold uppercase text-text-secondary">
                Full Name *
              </label>
              <input
                type="text"
                ...
                className="border border-border rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-primary"
              />
            </div>
            <div className="flex flex-col gap-1">
              <label className="text-[10px] 3xl:text-[12px] font-bold uppercase text-text-secondary">
              ...
              <input
                ...
                className={`border rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-primary ${phoneError ? "border-red-400" : "border-border"}`}
              />
              {phoneError && (
                <span className="text-[10px] 3xl:text-[12px] text-red-500">{phoneError}</span>
              )}
            </div>
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <textarea
              ...
              rows={2}
              className="border border-border rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-primary resize-none"
            />
          </div>
          ...
          <div className="flex justify-end gap-2 mt-2">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 border border-border rounded-xl text-sm font-semibold text-text-secondary hover:bg-gray-50 cursor-pointer"
            >
              Cancel
            </button>
            <button
