...
const FacilityMaster = () => {
  ...
  return (
    <div className="flex flex-col w-full h-full py-8 max-w-500 mx-auto relative page-container">
      <AddFacilityModal
        isOpen={isModalOpen}
        onClose={() => {
      ...
      <div className="flex items-center gap-4 bg-gray-50/80 p-2 rounded-xl mb-6">
        ...
        <div className="relative min-w-45">
          <select
            ...
            className="w-full appearance-none bg-gray-100 border-none rounded-lg px-8 py-2.5 text-base font-medium text-text-primary focus:outline-none cursor-pointer"
          >
        ...
        <div className="relative" ref={popoverRef}>
          <button
            ...
            className={`flex items-center gap-2 py-2.5 px-8 rounded-lg text-base font-medium transition-colors ${isMoreFiltersOpen ? "bg-gray-200 text-text-primary" : "bg-gray-100 hover:bg-gray-200 text-text-secondary"}`}
          >
            <FiFilter size={16} />
          ...
          <table className="table-container w-full min-w-200">
            <thead>
              <tr className="bg-gray-50/50">
                ...
                <th className="text-[10px] 3xl:text-[14px] font-bold text-text-secondary uppercase tracking-wider text-right py-3 px-8 pr-8">
                  Actions
                </th>
              </tr>
            </thead>
