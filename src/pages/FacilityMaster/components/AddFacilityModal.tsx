...
const AddFacilityModal = ({ isOpen, onClose, onSuccess, editData }: AddFacilityModalProps) => {
 ...
 />
 {errors.name && <p className="text-sm text-danger mt-1.5 font-medium">{errors.name}</p>}
 </div>
 <div>
 ...
 {errors.type && <p className="text-sm text-danger mt-1.5 font-medium">{errors.type}</p>}
 </div>
 </div>
 ...
 />
 {errors.capacity && <p className="text-sm text-danger mt-1.5 font-medium">{errors.capacity}</p>}
 </div>
 </div>
 </div>
 ...
 />
 {errors.basePrice && <p className="text-sm text-danger mt-1.5 font-medium">{errors.basePrice}</p>}
 </div>
 <div>
 ...
 <p className="col-span-full text-base text-text-secondary">
 ...
 className="hidden"
 />
 <span className={`text-base font-semibold ${formData.status === status ? 'text-primary' : 'text-text-primary'}`}>
 {status}
 </span>
 </div>
