...
const RoomCalendar = () => {
 ...
 <button
 onClick={handleToday}
 className="px-4 py-2 text-base font-semibold text-text-secondary bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors border border-border cursor-pointer"
 >
 Today
 </button>
 ...
 <span className="px-4 py-2 text-sm font-bold text-text-primary whitespace-nowrap">
 ...
 className="bg-gray-50 border border-border rounded-lg text-sm font-medium text-text-primary px-3 py-1.5 focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary"
 >
 ...
 <th className="px-6 py-4 text-left text-sm font-semibold text-text-secondary uppercase tracking-wider min-w-[200px] border-r border-border">
 Room Info
 </th>
 {days.map((day, idx) => (
 <th
 key={idx}
 className={`px-4 py-4 text-center text-sm font-semibold uppercase tracking-wider min-w-[120px] ${
 ...
 <td
 colSpan={8}
 className="text-center py-12 text-text-secondary text-base"
 >
