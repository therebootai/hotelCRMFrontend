          ...
          <div className="bg-card border border-border rounded-3xl shadow-card p-6 xl:p-8">
            ...
            <div className="grid grid-cols-2 gap-3 mb-8">
              ...
              <div className="bg-background border border-border rounded-xl p-3 flex flex-col items-center justify-center text-center overflow-hidden">
                ...
                <span className="text-base font-semibold text-text-primary truncate w-full px-1">
            ...
            {/* Info Note */}
            <div className="bg-warning/10 border border-warning/20 rounded-xl p-4 flex items-start gap-3 text-text-secondary text-sm leading-relaxed">
              <FiInfo size={16} className="shrink-0 mt-0.5 text-warning" />
              <p>Prices are automatically calculated including selected tax.</p>
            </div>
          </div>
        </div>
      </div>
