...
export default function RoomFilters({ filters, onFilterChange }: RoomFiltersProps) {
 ...
 className="appearance-none bg-background border border-transparent rounded-lg pl-4 pr-10 py-2 text-base text-text-primary font-medium hover:bg-border/40 focus:outline-none focus:ring-2 focus:ring-primary/20 transition-colors cursor-pointer outline-none"
 >
