...
export default function TaxGstMaster({
 ...
 <tr>
 <th className="px-6 py-4 text-[11px] font-semibold text-text-secondary uppercase tracking-wider w-[35%]">
 Tax Name
 </th>
 ...
 {!isLoading && (
 <div className="px-6 py-4 border-t border-border bg-background flex items-center justify-between text-base text-text-secondary">
 <span>
